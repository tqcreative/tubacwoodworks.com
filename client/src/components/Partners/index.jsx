            ...
            <div className="partners_items_go_here">
                ...
                <div id="partners_wrap" className="partners_deck" style={{ backgroundImage: `url(${partner_text.backgroundImage})` }}>
                    ...
                    <div class="partner_pair">
                        ...
                        <div id="partner_card_1" className="partner_card" style={{ backgroundImage: `url(${partner_1.picture})` }} onClick={() => {window.open(partner_1.url)}}>
                    ...
                    <div class="partner_pair">
                        <div id="partner_card_2" className="partner_card" style={{ backgroundImage: `url(${partner_2.picture})` }} onClick={() => {window.open(partner_2.url)}}>
                        ...
                        <div id="partner_card_3" className="partner_card" style={{ backgroundImage: `url(${partner_3.picture})` }} onClick={() => {window.open(partner_3.url)}}>
