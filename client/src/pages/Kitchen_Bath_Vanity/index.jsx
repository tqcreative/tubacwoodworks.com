		...
		if (this.props.user) {
			return (
				<div className="kitchen_root">
					...
					<LayoutBasic h2Tag={contentObject.paragraphTwo.h2Tag} pTag={contentObject.paragraphTwo.pTag} pTag2={contentObject.paragraphTwo.pTag2} pTag3={contentObject.paragraphTwo.pTag3} />
