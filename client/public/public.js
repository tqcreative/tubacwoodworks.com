...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("scroll", function (event) {
    ...
    try {
      if (
        ...
        document.getElementsByClassName(
          "parallax"
        )[0].style.backgroundPosition = "center " + yOffset / speed + "px";
      } else if (
        document.getElementsByClassName("hero_parallax") &&
        intViewportWidth < 899
      ) {
        document.getElementsByClassName(
          "hero_parallax"
        )[0].style.backgroundPosition = "center " + yOffset / speed + "px";
      }
    } catch (error) { /* Unable to identify location of objects on the dom. */}
    ...
    if (document.getElementById("quote_1")) {
      ...
      if (
        elementInViewport(document.getElementById("quote_1")) &&
    ...
    if (document.getElementById("card0")) {
      if (
        elementInViewport(document.getElementById("card0")) &&
    ...
    if (this.document.getElementById("footer")) {
      if (
        elementInViewport(this.document.getElementById("footer")) &&
        portfolioTriggers === true &&
    ...
    if (document.getElementById("card3")) {
      if (
        elementInViewport(document.getElementById("card3")) &&
        portfolioTriggersTwo === false
      ) {
        portfolioTriggersTwo = true;
        gsap.from("#card3", { duration: 1, delay: 0.2, opacity: 0, y: 300 });
        gsap.from("#card4", { duration: 1.5, delay: 0.2, opacity: 0, y: 300 });
        gsap.from("#card5", { duration: 2, delay: 0.2, opacity: 0, y: 300 });
      } else if (
        !elementInViewport(document.getElementById("card3")) &&
        portfolioTriggersTwo === true
      ) {
    ...
    if (document.getElementById("quote_2")) {
      if (
        elementInViewport(document.getElementById("quote_2")) &&
    ...
    if (document.getElementById("gallery_container")) {
      if (
        ...
        gsap.from(".item_1", { duration: 0.3, opacity: 0, delay: 1 });
        gsap.from(".item_2", { duration: 2.5, opacity: 0, delay: 0.3 });
        gsap.from(".item_3", { duration: 1.7, opacity: 0, delay: 0.3 });
        gsap.from(".item_4", { duration: 0.9, opacity: 0, delay: 0.3 });
        gsap.from(".item_5", { duration: 1.5, opacity: 0, delay: 0.3 });
        gsap.from(".item_6", { duration: 1.1, opacity: 0, delay: 0.5 });
        gsap.from(".item_7", { duration: 1.3, opacity: 0, delay: 1.8 });
        gsap.from(".item_8", { duration: 1.4, opacity: 0, delay: 0.3 });
        gsap.from(".item_9", { duration: 1, opacity: 0, delay: 0.3 });
        gsap.from(".item_10", { duration: 1.2, opacity: 0, delay: 0.5 });
    ...
    if (document.getElementById("checkerbox_quote_1")) {
      if (
        elementInViewport(document.getElementById("checkerbox_quote_1")) &&
        checkerOneTrigger === false
      ) {
        checkerOneTrigger = true;
        gsap.from("#checkerbox_quote_1", {
          duration: 1,
          opacity: 0,
          delay: 0,
          x: "101%",
    ...
    if (document.getElementById("checkerbox_quote_2")) {
      if (
        elementInViewport(document.getElementById("checkerbox_quote_2")) &&
        checkerTwoTrigger === false
      ) {
        checkerTwoTrigger = true;

        gsap.from("#checkerbox_quote_2", {
          duration: 1,
          opacity: 0,
          delay: 0.3,
          x: "101%",
    ...
    if (document.getElementById("checkerbox_quote_3")) {
      if (
        elementInViewport(document.getElementById("checkerbox_quote_3")) &&
        checkerThreeTrigger === false
      ) {
        checkerThreeTrigger = true;
        gsap.from("#checkerbox_quote_3", {
          duration: 1,
          opacity: 0,
          delay: 0.7,
          x: "101%",
    ...
    if (document.getElementById("phone")) {
      if (window.pageYOffset > 2000 && window.pageYOffset < 7000) {
        gsap.to("#phone", { duration: 0, delay: 0.1, x: 0 });
      } else if (window.pageYOffset < 1999 || window.pageYOffset > 7001) {
        gsap.to("#phone", { duration: 0, delay: 0.1, x: -100 });
      }
    }
  });
